...
router.get('/', async (req, res, next) => {
  try {
    ...
    const [arts] = await db.query("SELECT a.id, a.title, a.image_path, ar.name AS artist_name FROM artworks a JOIN artists ar ON a.artist_id = ar.id ORDER BY a.created_at DESC LIMIT 1");
